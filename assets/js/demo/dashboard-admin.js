$(document).ready(function() {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#totalClass').text(response.totalClass);
            $('#totalTeacher').text(response.totalTeacher);
            $('#totalStudent').text(response.totalStudent);
            ...
            var myPieChart = new Chart(ctxPie, {
                type: 'doughnut',
                data: {
                    labels: ["Tổng số lớp", "Tổng số giáo viên", "Tổng số sinh viên"],
                    datasets: [{
                        data: pieData,
                        backgroundColor: ['#36b9cc', '#1d72b8', '#1cc88a'],
                        hoverBackgroundColor: ['#2c9faf', '#155a8a', '#17a673'],
